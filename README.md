...
```bash
git clone https://github.com/ron0studios/logilinux-gui.git
cd logilinux-gui
```
...
- Built on top of [logilinux](https://github.com/ron0studios/logilinux) - The core C++ library for Logitech device communication
